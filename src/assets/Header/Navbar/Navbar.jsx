  ...
  return (
    <header
      className={`bg-transparent absolute top-0 left-0 w-full flex items-center z-10 ${
        isScrolled ? "fixed bg-tertiary" : "absolute"
      }`}
    >
      <div className="container">
        <div className="flex items-center justify-between relative">
          <div className="px-4">
            <a
              href="#hero"
              className="font-bold text-lg text-secondary block py-6 hover:text-black transition duration-200 ease-in-out"
            >
              Home
            </a>
          </div>
            ...
            >
              <span
                className={`hamburger-menu ${
                  isMenuOpen ? "open" : ""
                } origin-top-left transition duration-200 ease-in-out`}
              ></span>
              <span
                className={`hamburger-menu ${
                  isMenuOpen ? "open" : ""
              ...
              <span
                className={`hamburger-menu ${
                  isMenuOpen ? "open" : ""
                } origin-bottom-left transition duration-200 ease-in-out`}
              ></span>
            </button>
          </div>
          <nav
            className={`absolute bg-white shadow-lg max-w-[250px] w-full top-full right-1 transition-all duration-300 ease-in-out ${
